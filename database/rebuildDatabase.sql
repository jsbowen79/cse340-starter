...
CREATE TABLE IF NOT EXISTS public.drive (
    ...
    CONSTRAINT fk_drive_vehicle FOREIGN KEY (inv_id)
        REFERENCES public.inventory (inv_id)
        ON DELETE CASCADE,

    CONSTRAINT fk_host_account FOREIGN KEY (host_id)
        REFERENCES public.account (account_id),

    CONSTRAINT fk_customer_account FOREIGN KEY (customer_id)
        REFERENCES public.account (account_id),

    CONSTRAINT unique_drive_slot UNIQUE (inv_id, drive_date, drive_time),

    CONSTRAINT unique_host_appointment UNIQUE (host_id, drive_date, drive_time)
...
VALUES   (
  ...
  'Client',
  'basic@340.edu',
  '$2b$10$LmkBOPnSn90dQSdqT30mMeqaSiIbWHc.ZloX.XJMA8Mvho0AQYCPu',
  'Client'
),(
  'Happy',
  'Employee', 
  'happy@340.edu',
  '$2b$10$F6h.0sDlq4R491hSiO8EbuACfzy8qdsVG4D5r5vEgzT9h6Kkezgs2',
  'Client'
),(
  'Manager', 
  'User',
  'manager@340.edu',
  '$2b$10$xmCceD3ejRw7i0o.OFEnlu5Ko9/gsI96VZv6ZrlmqisSiQw3ztTjy', 
  'Admin'
)
